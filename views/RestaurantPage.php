<?php ?>
<div class='nav_bare navePlus'>
    <section class="bloc_nave">

    <section class='bloc_logo'>
        <p class='bloc_logo_p' ><img style='width: 30px;  height: 30px;' src="public/home.svg" alt=""></p>
    </section>
...
<div class='imgeFonResto'>
<img class='imgResto' src="public/asset/logo/resto.png" alt="">
</div>
